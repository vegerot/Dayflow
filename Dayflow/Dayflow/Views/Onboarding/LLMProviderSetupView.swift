      ...
      VStack(alignment: .leading, spacing: 24) {
        if activeProviderType == "doubao" {
          ...
          VStack(alignment: .leading, spacing: 12) {
            ...
            Text(
              "Use a vision-capable Ark model so Dayflow can read screenshots. You can change these later in Settings → AI Provider."
            )
            .font(.custom("Nunito", size: 12))
      ...
      VStack(alignment: .leading, spacing: 24) {
        if activeProviderType == "doubao" {
          ...
          .foregroundColor(.black.opacity(0.6))
            ...
            Text(
              "Doubao runs via Volcengine Ark. You'll need an API key from your Volcengine account."
            )
            .font(.custom("Nunito", size: 14))
            .foregroundColor(.black.opacity(0.6))
            ...
            DayflowSurfaceButton(
              ...
              content: {
                HStack(spacing: 8) {
                  ...
                  Text("Open Volcengine Console").font(.custom("Nunito", size: 14)).fontWeight(
                    .semibold)
                }
              },
              background: Color(red: 0.25, green: 0.17, blue: 0),
